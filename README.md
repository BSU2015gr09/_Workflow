...
(**без бонуса**) Написать программу заполнения массива А элементами в случайном порядке из массива В (заранее определенном). Например, B={'М','Д'}; или B={'Т','К','Д','В'}; 

(**на бонус**) Написать программу "перетасовки элементов массива А".

(**на бонус**) Написать программу "циклической перестановки элементов массива А" на k
...
б) В программе объявлен массив А целых элементов (размер массива 10). Пользователь
вводит массив c клавиатуры. Потом распечатываем массив. Вводим число N < 10. Затем удаляем N-ый элемент массива (сдвигая остальные элементы). 

в) В программе объявлен массив А элементов типа char (размер массива 20). Пользователь
вводит массив c клавиатуры. Затем ищем в массиве какая буква встречается чаще всего. Ее выводим на экран.

г) В программе объявлен массив А элементов типа char (размер массива 20). Пользователь
вводит массив c клавиатуры. Затем заменяем последнюю встреченную в массиве букву Z на букву F.
...
|N  |Прозвішча                     | КР1 | ДЗ1 |диктант|ДЗ2|ДЗ3 |КР2 | ДЗ4 |итого  |
|--:|:-----------------------------|:---:|----:|:---:|----:|:--:|----:|:--:|----:|
|  1|Бачище Яна Александровна      |  2  |     |     |     |    | 4   |    |
|  2|Бойко Максим Александрович    |  4  |     |  8  |   +?|++-?|     |    |
|  3|Войлоков Максим Сергеевич     |  10 |     |  7  |  +  |  + | 8   |    |
|  4|Гресский Никита Олегович      |  10 |     |  9  |  +  | +  | 7   |    |
|  5|Евсей Ирина Сергеевна         |  5  |     |  6  |--+  |  + | 5   |    |
|  6|Жук Дмитрий Иванович          |  5  |     |     |+--  | +  | 5   |    |
|  7|Климкович Надежда Викторовна  |  1  |     |  8  |     |  + | 5   |    |
|  8|Комаровский Дмитрий Юрьевич   |  6  |     |  10 |  +- |  +-| 8   |    |
|  9|Крейдич Александра Алексеевна |  6  |     |  9  | -+- |  - | 4   |    |
...
| 14|Шкляник Валерия Руслановна    |  7  |     |  5  |     | +- | 6   |    |
