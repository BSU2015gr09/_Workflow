...
В двумерном массиве NxM заполненном случайными натуральными числами найти *седловую точку* если она там есть. Седловой точкой называется элемент матрицы который является минимумом в строке и максимумом в столбце.
